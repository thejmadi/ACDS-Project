...
def main():
    ...
    title = ["Angles vs. Fractional Orbit", "Angular Velocities vs Fractional Orbit", "GG Torque", "EM Torque", "SP Torque"]
    xlab = ["Fractional Orbit"]
    ylab = ["Angles (rad)", "Angular Velocity (rad/sec)", "Torque"]
    labels = ["Roll", "Yaw", "Pitch", "Axis 1", "Axis 2", "Axis 3"]
    fc.PlotAngles(t/Period, x[:3, :], title[0], xlab[0], ylab[0], labels[:3])
    fc.PlotAngles(t/Period, x[3:6, :], title[1], xlab[0], ylab[1], labels[3:])
